    ...
    \begin{proofenv}
        ...
        If $r>1$, then there exists $\widetilde{N}$ such that $a_n^{1/n} >1$ for all $n\ge \sqrt{\widetilde{N}}$. Then $a_n>1$ for all $n\ge \widetilde{N}$ and thus $\displaystyle \lim_{n\to \infty} a_n$ cannot be $0$ and $\sum a_n$ diverges.
    ...
    \begin{exampleenv}
        \begin{enumerate}
            ...
            $$ \left| \frac{x^{n+1}}{(n+1)!} \cdot \frac{n!}{x^n} \right| = \frac{|x|}{n+1} \to 0 < 1\quad \text{for } x\neq 0$$
