...
\begin{notationenv}
    ...
    $$ \Jac{Y}{Z}{u}{v} = \dfrac{\partial Y}{\partial u} \dfrac{\partial Z}{\partial v} - \dfrac{\partial Y}{\partial v} \dfrac{\partial Z}{\partial u}. $$
    Then we can write
...
\end{proofenv}
\begin{remarkenv}
    There are some other common ways to write the surface integrals.
\end{remarkenv}
\begin{definitionenv}
...
\begin{proofenv}
    ...
    $$
    \int_\Gamma p \pdv{X}{v} \dd v + p \pdv{X}{u} \dd u = \int_a^b p(\bm \gamma (t)) \left( \left. \pdv{X}{u}\right| u'(t) + \left. \pdv{X}{v}\right| v'(t) \right) \dd t = \int_a^b p(\bm \gamma(t)) \dv{t} (X\circ \bm \gamma)(t) \dd t.
    $$
